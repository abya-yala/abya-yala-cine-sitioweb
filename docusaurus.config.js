...
const config = {
  title: 'Cine de Abya Yala',
  tagline: 'Una ontología de los festivales de cine autóctono de Abya Yala',
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/abya-yala',
            label: 'GitHub',
            position: 'right',
          },
        ],
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Cine de Abya yala. Hecho con Docusaurus.`,
      },
      prism: {
